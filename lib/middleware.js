...
exports.authenticateReturnHandler = function() {
  ...
  return function*authenticateReturnHandler(next) {
    ...
    var tokens = utils.filterVaildAutorizeTokensResponse(this.user_data.tokens.authorize_tokens)
...
exports.userAuthorizeTokensReturnHandler = function() {

  return function*getAuthorizeTokensReturnHandler(next) {
