...
exports.getLoginToken = function(client) {
  ...
  return function*getLoginToken(next) {
    ...
    assert(auth_token && auth_token.entity_id === this.request.entity._id, 'Invalid token')
    assert(utils.isNotExpired(auth_token), 'Token expired')
